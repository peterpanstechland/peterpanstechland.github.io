...
**Learning:** Fixed-height textareas in chat widgets frustrate users when typing long queries.
**Action:** Use a useEffect hook to sync style.height with scrollHeight on every input change for a fluid typing experience.
