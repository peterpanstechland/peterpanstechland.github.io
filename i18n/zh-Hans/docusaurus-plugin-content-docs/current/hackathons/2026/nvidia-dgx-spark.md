...
一切从飞书开始。你在飞书群里和云希对话，告诉她基础的出行信息：

- **出发地和目的地**——从哪里出发、想去哪里
- **出行方式**——自驾、高铁、飞机
- **参与人数**——几个大人、几个小孩
- **旅行偏好**——想吃海鲜还是想看古迹、预算范围、想不想打卡网红景点、有没有必去的地方

云希理解你的需求后，自动生成完整行程计划，并推送到前端网站 [travel-spark.peafamily.online](https://travel-spark.peafamily.online)。

![云希生成的汕尾详细旅行计划](/img/hackathons/2026/ai-guide.png)

### 🗺️ 阶段一：规划

在前端网站上，你看到的是云希生成的完整行程：
